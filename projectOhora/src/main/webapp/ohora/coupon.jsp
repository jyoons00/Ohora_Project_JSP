      ...
      <div id="SP_mypage_wrap">
        <div class="SP_subSection">
          <h2 class="SP_subTitle Nunito_Sans_font">
            <span class="eng_font">MY COUPON</span>
          </h2>
        </div>
        ...
        <div class="SP_layoutFix">
          ...
          >
            <div
              class="xans-element- xans-myshop xans-myshop-couponserial SP_couponInputBox_wrap"
            >
              <h3 class="tit">쿠폰 등록하기</h3>
              <div class="ec-base-box typeThinBg couponSerial">
                ...
                <fieldset>
                  ...
                  >
                  <p>
                    반드시 쇼핑몰에서 발행한 쿠폰번호만 입력해주세요. (10~35자
                    일련번호 '-' 제외)
                  </p>
                </fieldset>
              </div>
          ...
          >
            <div
              class="xans-element- xans-myshop xans-myshop-couponlist couponListTable"
            >
              <!--
          ...
          <div
            class="xans-element- xans-myshop xans-myshop-couponlistpaging SP_pagenation_wrap"
          >
          ...
          <div class="inner SP_layoutFix">
            ...
            <div class="SP_pageGuideTxt_cont bottom">
              <ol class="xans-element- xans-myshop xans-myshop-historyinfo">
                <li class="item1">
                  - 쿠폰은 주문 시 1개의 쿠폰만 적용 가능하며, 중복 할인 및
                  적용은 불가합니다
                </li>
                <li class="item2">
                  - 쿠폰은 주문 건 전체 취소/반품 시 자동 복원됩니다.<br />(교환,
                  부분 취소/반품 시 쿠폰 복원 불가)<br />(쿠폰 사용기간 이 후
                  취소/반품의 경우 원복 및 재발급이 되지 않습니다.)
                </li>
                <li class="item3">
                  - 쿠폰은 사용 기한이 지나면 자동 소멸되며, 기한 만료로 인한
                  재발급은 불가합니다.
                </li>
                <li class="item4">
                  - 쇼핑몰에서 발행한 종이 쿠폰/시리얼 쿠폰/모바일 쿠폰 등은
                  쿠폰번호를 등록하시면 온라인에서 사용이 가능합니다
                </li>
              </ol>
            </div>
          </div>
