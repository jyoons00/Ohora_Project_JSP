						...
						<div class="memberJoin-wrap">
									...
									<div class="agreeAllWrap">
										<div class="agreeAllBox">
											<div class="agreeAllinner">
												<p class="check">
													<span class="chk-base"> 
                                                        <input type="checkbox" id="AgreeAllCk" onclick="allAgreeBtn()"> 
                                            ...
                                            <tbody>
                                                <tr class="checked-vali">
                                                    ...
                                                    <td>
                                                        ...
                                                        <button type="button" onclick="id_jungbok()">중복 확인</button>
                                                        <!-- 중복확인 -> 온클릭 함수 -->
                                                        <span id="idMsg" class="txtOK error">[ ] 는 사용가능한 아이디입니다.</span>
                                                        <!-- 중복 검사 완료시 뜨는 메시지 error뜨면 해당 상황에 맞게 오류메시지 뜸-->
                                                ...
                                                <tr class="checked-vali">
                                                    ...
                                                    <td>
                                                        ...
                                                        <span id="pwConfirmMsg" class="">비밀번호가 일치하지 않습니다.</span>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr class="checked-vali">
                                                    ...
                                                    <td>
                                                        ...
                                                        <button type="button" onclick="email_jungbok() ">중복 확인</button>
                                                        <!-- 중복확인은 온클릭 함수 -->
                                                        <p id="emailMsg">사용 가능한 이메일입니다.</p>
                                                        <!-- 클래스 error 뜨면서 유효성 검사함 -->
                                                    </td>
                                                </tr>
                                                ...
                                                <tr class="checked-vali">
                                                    ...
                                                    <td>
                                                        ...
                                                        <button type="button" onclick="phone_jungbok()">휴대폰 인증</button>
                                                        <!-- 폰인증은 온클릭 함수 - 그냥 중복검사 정도하자-->
                                                        <div class="phoneMsg">이미 등록된 휴대전화입니다.</div>
                                                    </td>
                            ...
                            <div class="SP_joinsubmit_wrap inner_join_wrap">
                                <div class="inner_join">
                                    <a href="#" class="SP_cm_btn SP_btn_black_bg" onclick="copy_join_btn();">회원 가입하기</a>
                                </div>
                            </div>
